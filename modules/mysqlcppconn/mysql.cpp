...
//-------------- Query
Array MySQL::query_fetch_dictionary(String p_SQLquery, bool return_string) { return make_query(p_SQLquery, FUNC_DICT, emptyarray, return_string); }

Array MySQL::query_fetch_array(String p_SQLquery, bool return_string) { return make_query(p_SQLquery, FUNC_ARRAY, emptyarray, return_string); }

Array MySQL::query_get_columns_types(String p_SQLquery) { return make_query(p_SQLquery, FUNC_TYPE, emptyarray, true); }

Array MySQL::query_get_columns_names(String p_SQLquery) { return make_query(p_SQLquery, FUNC_NAME, emptyarray, true); }
